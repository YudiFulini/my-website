  ...
  return(
    <Row className="py-4 border-top border-bottom">
      <Col className="py-3" md={5}>
        ...
        <h1 className="text-white kanji-title py-2 m-0" style={{display:display.kanji}}>{character}</h1>
            ...
            examples.map((example,i)=>{
              return(
                <Row className="align-items-center" key={i}>
                  <Col>
                    <p className="text-white text-center p-0 m-0" style={{display:display.kanji}}>{example.japanese}</p>
                  </Col>
                  <Col>
                    <p className="text-white text-center p-0 m-0" style={{display:display.furigana}}>{example.furigana}</p>
                  </Col>
                  <Col>
